...
clean:
	@rm -rf p1 p1-32 p1j p1j32
all:	p1 p1-32 p1j p1j32
p1:
...
p1j:
	${CXX} ${CXXFLAGS} -static -D_JAM_ -o p1j p1.cc
p1j32:
	${CXX} ${CXXFLAGS} -static -D_JAM_ -D_FLOAT_BITS_=32 -o p1j32 p1.cc
p1j64:
	${CXX} ${CXXFLAGS} -static -D_JAM_ -D_FLOAT_BITS_=64 -o p1j64 p1.cc
